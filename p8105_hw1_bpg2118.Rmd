...
The penguins data set contains information on penguins! This
data set has `r nrow(penguins)` rows and `r ncol(penguins)` columns. This data 
is collected in the following column names: `r colnames(penguins)`. The mean 
flipper length is 
